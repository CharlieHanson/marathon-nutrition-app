...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-card border border-border bg-card text-card-foreground shadow-soft transition-shadow duration-200 hover:shadow-card',
      className
    )}
    {...props}
  />
...
const CardHeader = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('flex flex-col space-y-1.5 p-5 sm:p-6 border-b border-border', className)}
    {...props}
  />
));
