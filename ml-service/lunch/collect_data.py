...
SEARCH_TERMS = [
    # Proteins
    "chicken breast", "grilled chicken", "chicken strips", "fried chicken",
    "turkey", "turkey breast", "deli turkey", "roast turkey",
    "tuna", "tuna salad", "salmon", "grilled salmon",
    ...
    "chicken sandwich", "tuna sandwich", "veggie sandwich",
    "wrap", "chicken wrap", "turkey wrap", "falafel wrap",
    "pita", "pita pocket", "gyro",
    "sub", "hoagie", "hero",
    "panini", "grilled cheese", "reuben",
    
    # Burgers
    "burger", "hamburger", "cheeseburger", "turkey burger", "veggie burger",
    
    # Salads
    "salad", "caesar salad", "cobb salad", "greek salad",
    "chicken salad", "tuna salad", "garden salad",
    "spinach salad", "kale salad", "chopped salad",
    
    # Bowls
    "rice bowl", "burrito bowl", "buddha bowl", "grain bowl",
    "poke bowl", "teriyaki bowl", "quinoa bowl",
    
    # Soups
    "soup", "chicken noodle soup", "tomato soup", "minestrone",
    "chili", "lentil soup", "bean soup", "vegetable soup",
    
    # Mexican
    "burrito", "quesadilla", "taco", "enchilada", "fajitas",
    "nachos", "taco salad",
    
    # Pasta (lighter lunch versions)
    "pasta salad", "mac and cheese", "spaghetti", "penne pasta",
    
    # Pizza
    "pizza", "pizza slice", "personal pizza", "flatbread pizza",
    
    # Asian
    "sushi", "sushi roll", "california roll", "spicy tuna roll",
    "fried rice", "lo mein", "pad thai", "ramen",
    "spring roll", "dumplings",
    
    # Middle Eastern
    "falafel", "hummus", "shawarma", "kebab", "tabouleh"
]
