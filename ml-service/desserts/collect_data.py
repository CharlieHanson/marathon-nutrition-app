...
SEARCH_TERMS = [
    ...
    "sorbet", "sherbet", "gelato",
    "popsicle", "ice pop", "fudgesicle",
    "frozen fruit", "banana ice cream", "nice cream",
    "milkshake", "malt",
    
    # Cookies & bars
    "cookie", "chocolate chip cookie", "oatmeal cookie",
    "peanut butter cookie", "sugar cookie",
    "brownie", "blondie", "fudge brownie",
    "rice crispy treat", "granola bar dessert",
    "cookie bar", "lemon bar",
    
    # Cakes & cupcakes
    "cake", "chocolate cake", "vanilla cake", "birthday cake",
    "cheesecake", "carrot cake", "red velvet cake",
    "cupcake", "chocolate cupcake", "vanilla cupcake",
    "pound cake", "coffee cake", "bundt cake",
    
    # Pies & pastries
    "pie", "apple pie", "pumpkin pie", "pecan pie",
    "cherry pie", "blueberry pie", "key lime pie",
    "donut", "glazed donut", "chocolate donut",
    "danish", "croissant", "cinnamon roll",
    "turnover", "strudel", "tart",
    
    # Chocolate
    "dark chocolate", "milk chocolate", "chocolate bar",
    "chocolate truffle", "chocolate fudge",
    "chocolate pudding", "chocolate mousse",
    "chocolate chips", "chocolate candy",
    
    # Puddings & custards
    "pudding", "chocolate pudding", "vanilla pudding",
    "rice pudding", "bread pudding", "tapioca pudding",
    "custard", "flan", "creme brulee", "panna cotta",
    
    # Healthier desserts
    "yogurt parfait", "greek yogurt with honey",
    "fruit salad", "berry bowl", "fruit cup",
    "chia pudding", "overnight oats dessert",
    "protein shake dessert", "smoothie bowl dessert",
    "banana with chocolate", "apple with caramel",
    "frozen banana", "chocolate dipped strawberry",
    
    # Other desserts
    "jello", "gelatin",
    "cannoli", "tiramisu", "eclair",
    "churros", "funnel cake",
